...
// void drawLineX_gpsHelper(vector<int> head, int x, int cellSize, int currentFoodX, int& endX) {
//     if (head[0] == currentFoodX) { endX = head[0]; return; }
//     ofDrawRectangle(head[0] * cellSize, head[1] * cellSize, cellSize, cellSize);
//     head[0] -= x;
//     drawLineX_gpsHelper(head, x, cellSize, currentFoodX, endX);
// }

// void drawLineY_gpsHelper(vector<int> head, int y, int cellSize, int endX, int currentFoodY) {
//     if (head[1] == currentFoodY) { return; }
//     ofDrawRectangle(head[0] * cellSize, head[1] * cellSize, cellSize, cellSize);
//     if (head[0] == endX) {
//         head[1] -= y;
//     }
//     drawLineY_gpsHelper(head, y, cellSize, endX, currentFoodY);
// }

// void gps() {
//     if (snake->getHead()[0] == currentFoodX && snake->getHead()[1] == currentFoodY) { return; }
//     int x_dir = (currentFoodX > snake->getHead()[0]) ? -1 : 1;
//     int y_dir = (currentFoodY > snake->getHead()[1]) ? -1 : 1;
//     int endX;
//     if (snake->getHead()[0] != currentFoodX) {
//         drawLineX_gpsHelper(snake->getHead(), x_dir, cellSize, currentFoodX, endX);
//     }
//     if (snake->getHead()[1] != currentFoodY) {
//         drawLineY_gpsHelper(snake->getHead(), y_dir, cellSize, endX, currentFoodY);
//     }
// }
//--------------------------------------------------------------
